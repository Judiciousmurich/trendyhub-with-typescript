  ...
  return (
    <>
      ...
      <div className="flex mb-20">
        <div>
          <h1 className="text-[#f42c37] m-6 font-bold text-lg tracking-wide font-serif ">
            welcome to Trendyhub
          </h1>
          <h1 className="font-bold text-4xl m-6">Who Are We?</h1>
          <p className="m-8 text-[#686868]">
            ...
            when I hear the buzz of the little world among the stalks, and grow familiar <br />with the countless indescribable forms of the insects and flies, then I feel <br />the presence .
          </p>
          <button className="bg-[#f42c37] px-6 py-2 text-white rounded-[20px] mx-20">Contact Us</button>
        </div>
        <section id="about-app" className="section-p1">
          <h1 className="font-bold text-base tracking-wide capitalize ">
